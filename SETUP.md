...
**Pencil icon**
The edit button in GitHub's web interface. Tap it to edit any
file directly in your browser without needing any other tools.

**Raw URL**
A link that shows the plain text contents of a file instead
of the formatted GitHub page. AI models need the raw URL to
read your files. Always tap the "Raw" button to get it.
